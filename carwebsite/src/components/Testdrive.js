...
function Testdrive () {
  ...
  return (
    ...
    <form className="well form-horizontal" action=" "   id="contact_form">
<fieldset>


<legend>-------BOOK AN APPOITMENT----</legend>
...
<div className="form-group">
  ...
  <input name="website" placeholder="IF any" className="form-control" type="text"/>
    </div>
  </div>
</div>
 ...
 <div className="form-group">
                        <label className="col-md-4 control-label">Do you want to sell your old car</label>
...
<div className="form-group">
  <label className="col-md-4 control-label">Address Description</label>
    <div className="col-md-4 inputGroupContainer">
    <div className="input-group">
        <span className="input-group-addon"><i className="glyphicon glyphicon-pencil"></i></span>
        	<textarea className="form-control" name="comment" placeholder="Car Description"></textarea>
  </div>
  </div>
</div>


<div className="alert alert-success" role="alert" id="success_message">Success <i className="glyphicon glyphicon-thumbs-up"></i> Thanks for contacting us, you can also fill this form for better experience.</div>
